...
function getHelp(botName, databases) {
  ...
  const topDbs = (databases || []).slice(0, 8);

  return {
    markdown: `👋 **${botName}** here! I manage your **${dbCount} databases**.\n\n💬 _"What databases do I have?"_\n💬 _"Add a new client"_ → guided workflow\n💬 _"Analyze the CRM"_ → instant stats\n💬 _"Search for tasks"_\n💬 _"Log a call"_ / _"Add a shipment"_ / _"New meeting"_`,
    structured: { type: 'help', databases: topDbs },
    suggestions: [
